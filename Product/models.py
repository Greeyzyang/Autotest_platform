    ...
    def buid(self):
        ...
        if browser != 'android':
            ...
            desired_caps = {
                ...
                'appPackage': 'com.ryeex.sdk.demo',

                'appActivity': 'com.ryeex.sdkband.MainActivity',
            ...
            a = os.popen('netstat -ano | findstr 4723')
            t = a.read()
            if "LISTENING" not in t:
                os.system("start  appium -a 127.0.0.1 -p 4723 -bp 8200 -U 207182e4")
            time.sleep(2)
            return browser
